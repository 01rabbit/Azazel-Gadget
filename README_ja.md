...
- **tmux コンソール**  
  - `py/azazel_menu.py` は Wi-Fi 選択、OpenCanary の開始/停止/ログ表示、E-Paper テスト操作をまとめた curses メニュー。  
...
| Web UI（オプション） | `azazel_web/app.py` | `azazel-web.service` 経由で `10.55.0.10:8084` に Flask ダッシュボード/API を提供 |
