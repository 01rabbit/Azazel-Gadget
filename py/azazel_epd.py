...
def render_normal(
    ...
    # Load fonts
    # Mode line: icbmss20.ttf (as requested)
    font_mode = load_font(20, "icbm")
    # SSID line: keep Stardos and use requested size 15pt
    ...
    # Draw mode + SSID as two stacked lines (top area), without affecting lower evidence area.
