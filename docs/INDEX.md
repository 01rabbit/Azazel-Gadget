...
- AZ-04 Azazel-Grimoire (formerly Azazel-CTI; formal name Azazel-Grimoire
  ...
  series member.  
  Reference repository: [01rabbit/Azazel-Grimoire](https://github.com/01rabbit/Azazel-Grimoire)
- AZ-05 Azazel-Covenant (formerly Azazel-Common): Shared contracts library (distributed as `azazel-common`, installed via a pinned git tag; becomes `azazel-covenant` from v0.3.0) used across the
  ...
  Reference repository: [01rabbit/Azazel-Covenant](https://github.com/01rabbit/Azazel-Covenant)
...
| [concepts/azazel-common-adapter.md](concepts/azazel-common-adapter.md) | Reviewer / Developer | Plan to serialize Gadget state/mode/action/audit/notification through the shared Azazel-Covenant (formerly Azazel-Common) `azazel-common` schema (design note, no behavior change; historical record) |
| [concepts/azazel-common-usage.md](concepts/azazel-common-usage.md) | Developer | How Gadget uses Azazel-Covenant (formerly Azazel-Common) today: the shared StatusView emit→read→surface flow and field mapping |
